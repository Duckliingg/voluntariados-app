<?php
// views/admin/insignias/crear.php
$userType = 'admin';
include __DIR__ . '/../../layouts/header.php';
?>

<div class="page-header">
    <h2 class="section-title">Crear Nueva Insignia</h2>
...
<div class="form-container">
    <form method="POST" id="formCrearInsignia">
        <div class="form-row">
            ...
            <div class="form-group">
                ...
                <select name="categoria" class="form-control" required>
                    ...
                    <option value="ambiental" <?php echo (isset($_POST['categoria']) && $_POST['categoria'] == 'ambiental') ? 'selected' : ''; ?>>🌱 Ambiental</option>
                    <option value="social" <?php echo (isset($_POST['categoria']) && $_POST['categoria'] == 'social') ? 'selected' : ''; ?>>🤝 Social</option>
                    <option value="educativo" <?php echo (isset($_POST['categoria']) && $_POST['categoria'] == 'educativo') ? 'selected' : ''; ?>>📚 Educativo</option>
                    <option value="salud" <?php echo (isset($_POST['categoria']) && $_POST['categoria'] == 'salud') ? 'selected' : ''; ?>>🏥 Salud</option>
                    <option value="comunitario" <?php echo (isset($_POST['categoria']) && $_POST['categoria'] == 'comunitario') ? 'selected' : ''; ?>>🏘️ Comunitario</option>
                </select>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <textarea name="descripcion" class="form-control" rows="3"
                      placeholder="Describe qué representa esta insignia y cómo se obtiene"><?php echo isset($_POST['descripcion']) ? htmlspecialchars($_POST['descripcion']) : ''; ?></textarea>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="range-container">
                <input type="range" name="criterio_asistencia" id="criterioRange" 
                       ...
                       value="<?php echo isset($_POST['criterio_asistencia']) ? (int)$_POST['criterio_asistencia'] : 80; ?>">
                <span id="criterioValue">80%</span>
            </div>
        ...
        <div class="form-group">
            ...
            <div class="insignia-preview" id="preview">
                <div class="preview-header" id="previewHeader" style="background: #3498db;">
        ...
        <div class="form-actions">
            <button type="submit" class="btn">Crear Insignia</button>
