...
<h2 class="section-title">Editar Convocatoria</h2>
...
<form method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <textarea name="descripcion" class="form-control" rows="5" required><?php echo htmlspecialchars($convocatoria->descripcion); ?></textarea>
    </div>

    <div class="form-group">
        <label class="form-label">Lugar</label>
        <input type="text" name="lugar" class="form-control"
               value="<?php echo htmlspecialchars($convocatoria->lugar); ?>">
    </div>
        ...
        <select name="docente_id" class="form-control">
            ...
            <?php if (!empty($docentes)): ?>
                ...
                <option value="<?php echo $docente['id']; ?>"
                        <?php echo ($convocatoria->docente_id == $docente['id']) ? 'selected' : ''; ?>>
    ...
    <div class="form-group">
        ...
        <input type="text" name="contacto_responsable" class="form-control"
               value="<?php echo htmlspecialchars($convocatoria->contacto_responsable); ?>">
    </div>

    <div class="form-group">
        <label class="form-label">Teléfono Contacto</label>
        <input type="tel" name="telefono_contacto" class="form-control"
               value="<?php echo htmlspecialchars($convocatoria->telefono_contacto); ?>">
    </div>

    <div class="form-group">
        <label class="form-label">Link WhatsApp Grupo</label>
        <input type="url" name="whatsapp_grupo" class="form-control"
               value="<?php echo htmlspecialchars($convocatoria->whatsapp_grupo); ?>">
    </div>

    <div class="form-group">
        <label class="form-label">Tipo de Voluntariado</label>
        <select name="tipo_voluntariado" class="form-control">
            <option value="social" <?php echo $convocatoria->tipo_voluntariado == 'social' ? 'selected' : ''; ?>>Social</option>
            <option value="ambiental" <?php echo $convocatoria->tipo_voluntariado == 'ambiental' ? 'selected' : ''; ?>>Ambiental</option>
            <option value="educativo" <?php echo $convocatoria->tipo_voluntariado == 'educativo' ? 'selected' : ''; ?>>Educativo</option>
            <option value="salud" <?php echo $convocatoria->tipo_voluntariado == 'salud' ? 'selected' : ''; ?>>Salud</option>
            <option value="comunitario" <?php echo $convocatoria->tipo_voluntariado == 'comunitario' ? 'selected' : ''; ?>>Comunitario</option>
        </select>
    </div>
        ...
        <select name="insignia_id" class="form-control" id="insigniaSelect">
            ...
            <?php if (!empty($insignias)): ?>
                ...
                <option value="<?php echo $insignia['_id']; ?>"
                        ...
                        <?php echo (isset($convocatoria->insignia_id) && $convocatoria->insignia_id == $insignia['_id']) ? 'selected' : ''; ?>>
    ...
    <div class="form-group">
        ...
        <input type="number" name="cupos" class="form-control" min="1" required
               value="<?php echo $convocatoria->cupos; ?>">
    </div>
        ...
        <?php if(!empty($convocatoria->imagen)): ?>
            <div class="image-preview-box">
                <img src="<?php echo $baseUrl; ?>uploads/<?php echo htmlspecialchars($convocatoria->imagen); ?>"
                     alt="Imagen actual" class="convocatoria-detail-img">
            </div>
        <?php else: ?>
            <p>Sin imagen</p>
        <?php endif; ?>
...
// Trigger en caso de que venga seleccionado
